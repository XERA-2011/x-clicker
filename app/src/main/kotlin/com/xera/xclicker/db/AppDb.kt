...
import com.xera.xclicker.data.AppVisitLog
import com.xera.xclicker.data.CategoryConfig
import com.xera.xclicker.data.Snapshot
import com.xera.xclicker.data.SubsConfig
import com.xera.xclicker.data.SubsItem
import com.xera.xclicker.util.dbFolder
...
object DbSet {
    private val db by lazy {
        Room.databaseBuilder(
            app,
            AppDb::class.java,
            dbFolder.resolve("xclicker.db").absolutePath
