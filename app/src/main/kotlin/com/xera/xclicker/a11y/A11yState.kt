...
import com.xera.xclicker.data.ActionLog
import com.xera.xclicker.data.ActionResult
import com.xera.xclicker.data.ActivityLog
import com.xera.xclicker.data.AttrInfo
import com.xera.xclicker.data.ResetMatchType
import com.xera.xclicker.data.ResolvedRule
import com.xera.xclicker.data.RuleStatus
import com.xera.xclicker.data.isSystem
import com.xera.xclicker.db.DbSet

import com.xera.xclicker.store.actionCountFlow
import com.xera.xclicker.store.checkAppBlockMatch
import com.xera.xclicker.util.AndroidTarget
import com.xera.xclicker.util.LogUtils
import com.xera.xclicker.util.PKG_FLAGS
import com.xera.xclicker.util.RuleSummary
...
val activityRuleFlow: kotlinx.coroutines.flow.StateFlow<ActivityRule>
    get() = A11yState.activityRuleFlow

val topActivityFlow: kotlinx.coroutines.flow.StateFlow<TopActivity> by lazy {
    activityRuleFlow.mapState(appScope) { it.topActivity }
}

val currentTopActivity: TopActivity
    get() = A11yState.withTopActivityLock { activityRuleFlow.value.topActivity }
