...
val gitInfo = GitInfo(
    commitId = runCatching { "git rev-parse HEAD".runCommand() }.getOrElse { "unknown" },
    commitTime = runCatching { "git log -1 --format=%ct".runCommand() + "000" }.getOrElse { System.currentTimeMillis().toString() },
